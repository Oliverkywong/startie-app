...
describe("Integration test of userService", () => {
  ...
  it("can register", async () => {
    ...
    expect(await checkPassword('alex', registerRecord.user[0].password)).toBe(true)
    expect(registerRecord.user[0].email).toBe("alex@gmail.com");
    expect(registerRecord.user_tag[0].user_id).toBe(105);
  ...
  it("gets user information", async () => {
    ...
    expect(userRecord[0].description).toBe("testing long descriptiontesting long descriptiontesting long descriptiontesting long descriptiontesting long descriptiontesting long descriptiontesting long descriptiontesting long descriptiontesting long description");
  ...
  it("can edit user information", async () => {
    ...
    expect(userRecord.username).toBe("Oliver Wong");
    ...
    expect(userRecord.shortDescription).toBe("This is short description");
  });
  // -------------------------------------------------------------------------------------------------------------------
  //  Error edit user information (UserNameAlreadyExistError)
  // -------------------------------------------------------------------------------------------------------------------
  it("cannot edit user information", async () => {
    const phoneNumber = "95804971";
    const description = "I am Oliver Wong";
    const shortDescription = "This is short description";
    const profilepic = "oliverwong.jpg";
    ...
    try {
      ...
      expect(err).toBeInstanceOf(UserNameAlreadyExistError);
    }
  });
});
